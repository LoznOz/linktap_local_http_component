...
async def async_setup_entry(
    ...
    for tap in taps:
        ...
        binary_sensors.append(LinktapBinarySensor(coordinator, hass, tap=tap, name="Connected", data_attribute="is_rf_linked"))
        binary_sensors.append(LinktapBinarySensor(coordinator, hass, tap=tap, name="Detected Fall", data_attribute="is_fall", icon="mdi:meter-electric-outline"))
        binary_sensors.append(LinktapBinarySensor(coordinator, hass, tap=tap, name="Detected Water Cutoff", data_attribute="is_cutoff", icon="mdi:scissors-cutting"))
        binary_sensors.append(LinktapBinarySensor(coordinator, hass, tap=tap, name="Detected Leak", data_attribute="is_leak", icon="mdi:leak"))
        binary_sensors.append(LinktapBinarySensor(coordinator, hass, tap=tap, name="Detected Clog", data_attribute="is_clog", icon="mdi:leak-off"))
        binary_sensors.append(LinktapBinarySensor(coordinator, hass, tap=tap, name="Detected Device Fault", data_attribute="is_broken", icon="mdi:scissors-cutting"))
        binary_sensors.append(LinktapBinarySensor(coordinator, hass, tap=tap, name="Manual Watering", data_attribute="is_manual_mode", icon="mdi:account-switch"))
        binary_sensors.append(LinktapBinarySensor(coordinator, hass, tap=tap, name="Watering", data_attribute="is_watering", icon="mdi:water"))
        binary_sensors.append(LinktapBinarySensor(coordinator, hass, tap=tap, name="Watering Paused", data_attribute="is_paused", icon="mdi:pause"))
